...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendEmailB = findViewById(R.id.reset_password_email_button);
        emailInputET = findViewById(R.id.reset_password_email_input);
        ...
        sendEmailB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String userEmail = emailInputET.getText().toString();
                    ...
                    mAuth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(ResetPasswordActivity.this, "Please! check your email address!", Toast.LENGTH_LONG).show();
